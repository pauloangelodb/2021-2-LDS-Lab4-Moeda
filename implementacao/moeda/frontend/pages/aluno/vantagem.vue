...
<script>
import modalTransacaoVantagemVue from "../../components/transacao/modalTransacaoVantagem.vue"
export default {
  layout: "index",
  components: {
    modalTransacaoVantagemVue,
  },
  ...
  methods: {
    ...
    listaTransacoes() {
      ...
      this.$axios.$get(`/aluno/vantagem?pagina=${this.tabelaPaginaAtual}`).then(response => {
