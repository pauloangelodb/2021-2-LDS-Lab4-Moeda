    ...
    <v-card class="mx-auto pa-5 mt-3" width="100%">
      <div class="div-titulo-btn">
        ...
        <v-card-actions>
          ...
          <!-- <modalTratamento v-model="modalAtivo" v-bind:tratamentoId="tratamentoId" @professorProfessors="professorProfessors" /> -->
        </v-card-actions>
      </div>
      <!-- Filtro Simples -->
      <v-card-text class="text-h5">
        <template>
          <v-data-table
            ...
            v-if="professors && professors.length > 0"
            :headers="headers"
            :items="professors"
