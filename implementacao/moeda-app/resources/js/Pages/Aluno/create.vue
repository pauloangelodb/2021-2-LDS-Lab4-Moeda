                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mt-4">
                                <BreezeLabel for="password_confirmation" value="Curso" />
                                <!-- <select id="password_confirmation" type="select" class="mt-1 block w-full" v-model="form.password_confirmation" required autocomplete="new-password" /> -->
